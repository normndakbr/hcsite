...
class Karyawan_model extends CI_Model
{
     ...
     var $order = array('nama_lengkap' => 'desc'); // default order 
     ...
     public function get_karyawan_id($auth_karyawan)
     {
          $query = $this->db->get_where('vw_karyawan', ['auth_karyawan' => $auth_karyawan]);
          return $query->result();
     }
