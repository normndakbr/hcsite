...
<body class=" bg-c-blue">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a id="bc1" href="javascript:void(0);">
                                        Karyawan
                                    </a>
                                </li>
                                <li class="breadcrumb-item">
                        ...
                        <div class="card-body">
                            <div class="mt-3">
                                <div class="mb-2">
                                    ...
                                    <a id="addRefreshKary" href="javascript:void(0);" class="btn btn-primary font-weight-bold"><i
                                            class="fas fa-sync-alt"></i> Refresh</a>
                                    <a id="addTambahKary" href="<?= base_url('view_create_karyawan'); ?>" target="_blank"
    ...
    <script type="text/javascript" src="<?= base_url()?>assets/js/karyawan.js?auth=<?= date('YmdHis') ?>"></script>
</body>
