                         ...
                         <div class="card-body">
                              <div class="mt-3">
                                   <div class="mb-2">
                                        ...
                                        <a id="addbtn" href="<?= base_url('user/new'); ?>" class="btn btn-success font-weight-bold">Tambah Data</a>
                                   </div>
                                   <div class="alert alert-danger err_psn_user animate__animated animate__bounce d-none"></div>
                              </div>
                              <div class="row">
                                   <div class="col-lg-12">
