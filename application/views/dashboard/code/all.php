          ...
          $.ajax({
               ...
               success: function(data) {
                    ...
                    if (data.statusCode == 200) {
                         ...
                         $("#error3est").html('');
                         $("#error4est").html('');
                         $(".err_psn_statjanji").fadeTo(3000, 500).slideUp(500,
                              function() {
                         ...
                         $(".err_psn_edit_statjanji").fadeTo(3000, 500).slideUp(500,
                              function() {
               ...
               error: function(xhr, ajaxOptions, thrownError) {
                    ...
                    if (xhr.status == 404) {
                         $(".err_psn_statjanji").html(
                              "StatJanji gagal diupdate, Link data tidak ditemukan"
                         );
                    } else if (xhr.status == 0) {
                         $(".err_psn_statjanji").html(
                              "StatJanji gagal diupdate, Waktu koneksi habis");
                    } else {
                         $(".err_psn_statjanji").html(
     ...
     $(document).ready(function() {
          ...
          $("#btnTambahStatJanji").click(function() {
               ...
               $.ajax({
                    ...
                    success: function(data) {
                         var data = JSON.parse(data);
                         if (data.statusCode == 200) {
                              $(".err_psn_statjanji").removeClass(
                                   'd-none');
                              $(".err_psn_statjanji").removeClass(
                                   'alert-danger');
                              $(".err_psn_statjanji").addClass(
                                   'alert-info');
                              $(".err_psn_statjanji").html(data.pesan);
                              $("#perStatJanji").val('').trigger('change');
                              $("#kodeStatJanji").val('');
                         ...
                         $(".err_psn_statjanji").fadeTo(3000, 500).slideUp(
                              500,
                              function() {
                                   $(".err_psn_statjanji").slideUp(
                                        500);
                              });
                    },
                    error: function(xhr, ajaxOptions, thrownError) {
                         ...
                         if (xhr.status == 404) {
                              $(".err_psn_statjanji").html(
                                   "StatJanji gagal disimpan, Link data tidak ditemukan"
                              );
                         } else if (xhr.status == 0) {
                              $(".err_psn_statjanji").html(
                                   "StatJanji gagal disimpan, Waktu koneksi habis"
                              );
                         } else {
                              $(".err_psn_statjanji").html(
                         ...
                         $(".err_psn_statjanji ").fadeTo(3000, 500)
          ...
          $(document).on('click', '.hpsstat_perjanjian', function() {
               ...
               if (auth_stat_perjanjian == "") {
                    ...
                    swal({
                         title: "Hapus",
                         text: "Yakin status perjanjian " + namaStatJanji +
                              " akan dihapus?",
                         type: 'question',
                         ...
                         if (result.value) {
                              ...
                              $.ajax({
                                   ...
                                   error: function(xhr, ajaxOptions,
                                        ...
                                        if (xhr.status == 404) {
                                             $(".err_psn_statjanji")
                                                  .html(
                                                       "StatJanji gagal dihapus, , Link data tidak ditemukan"
                                                  );
                                        } else if (xhr.status ==
                                             0) {
                                             $(".err_psn_statjanji")
                                                  .html(
                                                       "StatJanji gagal dihapus, Waktu koneksi habis"
                                                  );
                                        } else {
                                             $(".err_psn_statjanji")
                                                  .html(
                              ...
                              swal('Batal', 'Status Perjanjian ' +
                                   namaStatJanji + ' batal dihapus',
                                   'error');
                              return false;
                         }
                    });
               ...
               if (auth_stat_perjanjian == "") {
                    ...
                    $.ajax({
                         ...
                         success: function(data) {
                              var data = JSON.parse(data);
                              if (data.statusCode == 200) {
                                   $("#detailStatJanjiPerusahaan").val(data
                                        .nama_perusahaan);
                                   $("#detailStatJanjiDepart").val(data
                                        .depart);
                                   $("#detailStatJanjiKode").val(data
                                        .kode);
                                   $("#detailStatJanji").val(data
                                        .stat_perjanjian);
                                   $("#detailStatJanjiStatus").val(data
                                        .status);
                                   $("#detailStatJanjiKet").val(data.ket);
                                   $("#detailStatJanjiBuat").val(data
                                        .pembuat);
                                   $("#detailStatJanjiTglBuat").val(data
                                        .tgl_buat);
                                   $("#detailStatJanjimdl").modal("show");
                              } else {
                                   $(".err_psn_statjanji").css("display",
                                        "block");
                                   $(".err_psn_statjanji").html(data
                                        .pesan);
                              }
                         },
                         error: function(xhr, ajaxOptions, thrownError) {
                              ...
                              if (xhr.status == 404) {
                                   $(".err_psn_statjanji").html(
                                        "Status Perjanjian gagal ditampilkan, Link data tidak ditemukan"
                                   );
                              } else if (xhr.status == 0) {
                                   $(".err_psn_statjanji").html(
                                        "Status Perjanjian gagal ditampilkan, Waktu koneksi habis"
                                   );
                              } else {
                                   $(".err_psn_statjanji").html(
                    ...
                    $.ajax({
                         ...
                         success: function(data) {
                              ...
                              if (dataStatJanji.statusCode == 200) {
                                   $("#editStatJanjiKode").val(
                                        dataStatJanji.kode);
                                   $("#editStatJanji").val(dataStatJanji
                                        .stat_perjanjian);
                                   $("#editStatJanjiStatus").val(
                                        dataStatJanji.status);
                                   $("#editStatJanjiKet").val(dataStatJanji
                                        .ket);
                         ...
                         error: function(xhr, ajaxOptions, thrownError) {
                              ...
                              if (xhr.status == 404) {
                                   $(".err_psn_statjanji").html(
                                        "StatJanji gagal ditampilkan, Link data tidak ditemukan"
                                   );
                              } else if (xhr.status == 0) {
                                   $(".err_psn_statjanji").html(
                                        "StatJanji gagal ditampilkan, Waktu koneksi habis"
                                   );
                              } else {
                                   $(".err_psn_statjanji").html(
                                        "Terjadi kesalahan saat menampilkan data, hubungi administrator"
               ...
               "ajax": {
                    ...
                    "error": function(xhr, error, code) {
                         if (code != "") {
                              ...
                              $(".err_psn_statjanji").css("display", "block");
                              $(".err_psn_statjanji").html(
                                   "terjadi kesalahan saat melakukan load data perjanjian, hubungi administrator"
                              );
