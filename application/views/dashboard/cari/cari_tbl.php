...
if (!empty($data_kry)) {
    foreach ($data_kry as $list) {
        ...
        echo '<td class="align-middle text-nowrap text-center" style="width: 1%;"><a href="' . base_url('karyawan/dtl/' . $list->auth_karyawan) . '" class="btn btn-primary btn-sm"><i class="fas fa-asterisk"></i></a></td>';
        echo '</tr>';
    }
} else {
    echo '<tr>';
